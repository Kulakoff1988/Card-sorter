 ...
 * Ключей может быть больше или меньше, следовательно нужно менять шаблон в функции "getTripDescription" (см. выше) в соответствии
 ...
 * массива, убрав в последней строчке функции `.join(`\n`)`
 */
